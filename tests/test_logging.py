...
class TestLoggingRollupMetrics:
    def test_rollup(self, caplog):
        ...
        with freeze_time('2017-04-19 12:00:00'):
            ...
            lm.emit_to_backend(MetricsRecord('histogram', key='save_time', value=50, tags=None))
            lm.emit_to_backend(MetricsRecord('histogram', key='save_time', value=60, tags=None))
