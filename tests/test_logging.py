...
class TestLoggingMetrics:
    def test_incr(self, caplog):
        ...
        assert (
            ...
            [
                ('metrics', 20, 'METRICS|2017-03-06 11:30:00|incr|foo|10|#key1:val,key2:val')
            ]
        )
    ...
    def test_gauge(self, caplog):
        ...
        assert (
            caplog.record_tuples ==
            [
                ('metrics', 20, 'METRICS|2017-03-06 11:30:00|gauge|foo|100|#key1:val,key2:val')
            ]
        )
    ...
    def test_timing(self, caplog):
        ...
        assert (
            caplog.record_tuples ==
            [
                ('metrics', 20, 'METRICS|2017-03-06 11:30:00|timing|foo|1234|#key1:val,key2:val')
            ]
        )
    ...
    def test_histogram(self, caplog):
        ...
        assert (
            caplog.record_tuples ==
            [
                ('metrics', 20, 'METRICS|2017-03-06 11:30:00|histogram|foo|4321|#key1:val,key2:val')
            ]
        )
